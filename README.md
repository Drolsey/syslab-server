...
| 4 | The retrieval plane: which parts of a document bear on this question | **In progress.** Signed off 11 Sep; 4.0 (the tenant bridge) is built and gated. `docs/plans/step-04-retrieval-plane.md` |
