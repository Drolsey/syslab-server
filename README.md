...
| 4 | The retrieval plane: which parts of a document bear on this question | **Planned**, not started. `docs/plans/step-04-retrieval-plane.md`, awaiting sign-off on its six decisions |
