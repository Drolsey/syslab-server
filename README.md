...
| 4 | The retrieval plane, and the seams the rest plugs into | **In progress.** 4.0 (the tenant bridge) built and gated 11 Sep. Plan rewritten the same day around four extension points rather than features. `docs/plans/step-04-retrieval-plane.md` |
